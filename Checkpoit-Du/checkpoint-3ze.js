...
const curso2 = new Curso("python", 7.0, 10, estudantes);
// console.log(curso1);
...
console.log(`---${curso2.nomeCurso}---`);
console.table(curso2.mostradorAprovados());

console.log("---LISTA DE REPROVADOS---");
console.log(`---${curso2.nomeCurso}---`);
console.table(curso2.mostradorReprovados());
